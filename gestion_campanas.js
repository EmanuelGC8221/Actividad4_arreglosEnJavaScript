...
// TODO: Escribe tu código aquí
let eliminarEspecialista = especialistas.pop();
console.log("El especialista eliminado (pop) es:", eliminarEspecialista);
console.log("Especialistas finales:", especialistas);
...
console.log("Nuevo especialista:", especialistas);
// TODO 4: Usar shift para eliminar el primer especialista y almacenarlo en una variable
// Imprime el especialista eliminado y el arreglo actualizado
// TODO: Escribe tu código aquí
elimimarPrimerEspecialista = especialistas.shift ();
console.log("El especialista eliminado (shift) es:", elimimarPrimerEspecialista)
console.log ("Especialistas finales:", especialistas);
...
console.log("Sublista de especialistas:", subLista);
...
console.log("Total especialistas por campaña");
i=0
for (let equipo of campanas) {
  console.log(`Campaña ${++i} con: ${equipo.length} especialistas`);
}
...
console.log("Nuevos nombres de los especialistas en mayúsculas");
...
console.log("función que genera reporte completo usando bucle for clásico");

function generarReporteCompleto(campanas) {
  console.log("Reporte Completo de Campañas:");
  for (let i = 0; i < campanas.length; i++) {
    console.log(`Campaña ${i + 1} (${campanas[i].length} empleados):`);
...
console.log("EQUIPO CONFORMADO POR ANA MARÍA, DARWIN ALEXIS, SARA GARCÍA Y EMANUEL GIRALDO");
